...
abstract class MyItemTouch(
    ...
    private lateinit var buttonsBuffer: MutableMap<Int, MutableList<UnderlayButton>>
    ...
    private val onTouchListener = OnTouchListener { view, e ->
        ...
        if (swipedViewHolder == null) return@OnTouchListener false
